...
//   let evidenceList = logbookClara.getElementsByTagName('ul')[0];
//   let alibiText = logbookClara.getElementsByTagName('p')[0];

//   evidenceList.children[0].textContent = claraDeveraux.evidence;
//   evidenceList.children[1].textContent = claraDeveraux.additionalEvidence;
//   alibiText.textContent = claraDeveraux.alibi;
