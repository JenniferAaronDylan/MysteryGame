...
function logJonathon() {
  document.getElementById("jon-evidence").innerText = `Jonathon's Evidence: ${jonathanVanDyke.evidence}`;
  document.getElementById("jon-alibi").innerText = `Jonathon's Alibi: ${jonathanVanDyke.alibi}`;
}
...
function logWallace() {
  document.getElementById("wallace-evidence").innerText = `Wallace's Evidence: ${captainWallace.evidence}`;
  document.getElementById("wallace-alibi").innerText = `Wallace's Alibi: ${captainWallace.alibi}`;
}
